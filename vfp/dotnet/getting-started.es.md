---
title: Primeros pasos con el Video Fingerprinting SDK .NET
...
Ningún paquete adicional: los controles `VideoView` de Apple y Android se fusionaron en `VisioForge.DotNet.Core`.
