---
title: Instalar TVFVideoEdit en Delphi, ActiveX y otros IDEs
...
Para instrucciones detalladas sobre la instalación de los paquetes TVFVideoEdit en su IDE Delphi, por favor consulte la siguiente [guía de instalación de Delphi](delphi.md).

### Instalación de ActiveX

#### C++ Builder

Para [C++ Builder](builder.md), el proceso de instalación involucra importar el control ActiveX en su proyecto. Este proceso directo asegura que pueda comenzar rápidamente a usar la biblioteca TVFVideoEdit en sus proyectos de C++ Builder.
