...
* [**Captura de Pantalla a Formato AVI**](screen-capture-avi.md) - Implementa captura de pantalla completa o de región al formato AVI estándar de la industria con codecs configurables
* [**Grabación de Pantalla a Archivos MP4**](screen-capture-mp4.md) - Crea grabaciones MP4 eficientes de la actividad del escritorio con configuraciones de calidad ajustables
* [**Captura de Pantalla con Salida WMV**](screen-capture-wmv.md) - Utiliza el formato WMV para grabaciones de pantalla con tamaño de archivo optimizado y compatibilidad
...
* [**Grabación de Video de Webcam a AVI**](video-capture-camera-avi.md) - Integra grabación de webcam con formato de salida AVI y compatibilidad DirectShow
* [**Captura de Webcam a Archivos MP4**](video-capture-webcam-mp4.md) - Implementa grabación de webcam de alta calidad con compresión H.264 para tamaño de archivo óptimo
* [**Grabación de Webcam con Salida WMV**](video-capture-webcam-wmv.md) - Crea grabaciones en formato WMV eficientes desde entrada de webcam con compatibilidad Windows Media
* [**Superposición de Texto en Grabaciones de Webcam**](webcam-capture-text-overlay.md) - Aprende a agregar texto dinámico, marcas de tiempo y marcas de agua al metraje de webcam con fuentes y posicionamiento personalizables
