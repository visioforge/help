...
description: Windows 10/11, macOS 12+, Ubuntu 22.04+, iOS 12+, Android 9+. .NET 6–9, soporte ARM64, requisitos de memoria 4K. Compatible con WPF, WinForms, MAUI y Avalonia.
tags:
  - Video Capture SDK
  - Media Player SDK
  - Media Blocks SDK
...
* Android 9 (nivel de API 28) o más reciente
