...
Pinned NuGet version: **`2026.9.22`** (matches the [official Video Capture Console sample](https://github.com/visioforge/.Net-SDK-s-samples/tree/master/Video%20Capture%20SDK/Console/Video%20Capture%20Demo)). Newer 2026.x.x patch versions are drop-in compatible.
