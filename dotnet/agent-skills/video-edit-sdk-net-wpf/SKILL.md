...
Pinned NuGet version: **`2026.9.22`** (matches the official Cut Video File and Video Join Demo samples). Newer 2026.x.x patch versions are drop-in compatible.
