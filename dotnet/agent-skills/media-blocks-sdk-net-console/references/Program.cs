...
namespace FileConvert
{
    ...
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            // Event-driven wait for completion: OnStop completes the task, OnError surfaces the failure.
            var doneTcs = new TaskCompletionSource<bool>();
            pipeline.OnStop += (s, e) => doneTcs.TrySetResult(true);
            pipeline.OnError += (s, e) => doneTcs.TrySetException(new Exception(e.Message));
