...
Pinned NuGet version: **`2026.8.16`** (matches the [official Simple Player Demo sample](https://github.com/visioforge/.Net-SDK-s-samples/tree/master/Media%20Player%20SDK/WPF/CSharp/Simple%20Player%20Demo)). Newer 2026.x.x patch versions are drop-in compatible.
