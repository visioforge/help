...
namespace Simple_Media_Player
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            // We initialize the engine on first activation, not in the constructor —
            // on Linux the native VideoView is only fully parented at first activation.
        ...
        private async void btStart_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                // UniversalSourceSettings transparently handles file paths, http(s) URLs, RTSP, etc.
        ...
        {
            // OnError may fire on a non-UI thread — marshal before touching Avalonia controls.
            Dispatcher.UIThread.Post(() => Log.Add(e.Message));
        }
        ...
        private void btReadTags_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Read tags error: {ex.Message}");
            }
        }
