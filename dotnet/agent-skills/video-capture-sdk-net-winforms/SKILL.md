...
Pinned NuGet version: **`2026.9.17`** (matches the [official Simple Video Capture sample](https://github.com/visioforge/.Net-SDK-s-samples/tree/master/Video%20Capture%20SDK/WinForms/CSharp/Simple%20VideoCapture)). Newer 2026.x.x patch versions are drop-in compatible.
