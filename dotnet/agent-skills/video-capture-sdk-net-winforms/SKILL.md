...
Pinned NuGet version: **`2026.9.22`** (matches the [official Simple Video Capture sample](https://github.com/visioforge/.Net-SDK-s-samples/tree/master/Video%20Capture%20SDK/WinForms/CSharp/Simple%20VideoCapture)). Newer 2026.x.x patch versions are drop-in compatible.
...
- **WPF instead of WinForms**: same SDK, different UI host → [`video-capture-sdk-net-wpf`](https://www.visioforge.com/.well-known/agent-skills/video-capture-sdk-net-wpf.zip).
...
- **Adjacent skills**:
    - [`video-capture-sdk-net-wpf`](https://www.visioforge.com/.well-known/agent-skills/video-capture-sdk-net-wpf.zip) — same SDK on WPF.
