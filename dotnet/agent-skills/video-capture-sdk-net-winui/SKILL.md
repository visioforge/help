...
<ItemGroup>
  <PackageReference Include="VisioForge.DotNet.Core.Redist.VideoCapture.x64" Version="2026.8.16" />
  <PackageReference Include="VisioForge.DotNet.Core.Redist.MP4.x64" Version="2026.8.16" />
  <PackageReference Include="VisioForge.DotNet.Core.Redist.LAV.x64" Version="2026.8.16" />
</ItemGroup>
```
