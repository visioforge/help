...
El control de tasa también requiere el runtime de GStreamer 1.28.6, que se incluye en los paquetes
de macOS y Mac Catalyst. El paquete de iOS todavía incluye 1.24.9, cuyo codificador VideoToolbox no
expone estas propiedades en absoluto: allí el ajuste se descarta con una advertencia en lugar de
