...
Le contrôle de débit exige également le runtime GStreamer 1.28.6, livré avec les paquets macOS et
Mac Catalyst. Le paquet iOS embarque encore 1.24.9, dont l'encodeur VideoToolbox n'expose pas du
tout ces propriétés : le réglage y est ignoré avec un avertissement plutôt qu'appliqué en
silence.
