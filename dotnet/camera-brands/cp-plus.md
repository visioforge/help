---
title: How to Connect to CP Plus IP Camera in C# .NET
description: Connect to CP Plus cameras in C# .NET with RTSP URL patterns and code samples for UNC, NC, RNP, Guard+, and Cosmic series models.
---
