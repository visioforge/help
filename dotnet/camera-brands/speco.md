...
description: Connect to Speco Technologies cameras and DVRs in C# .NET with RTSP URL patterns and code samples for O Series, VIP, LS, ZIP, SIP, and DVR models.
---
