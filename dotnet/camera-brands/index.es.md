...
=== "Multiplataforma (recomendado)"
    ...
    Sustituya el segundo paquete por el runtime nativo de su sistema operativo:
    `VisioForge.CrossPlatform.Core.Linux.x64`, `.macOS`, `.Android` o `.iOS`.

=== "Solo Windows (motor heredado DirectShow)"
